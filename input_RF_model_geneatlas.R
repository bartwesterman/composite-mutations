...
setwd("~/Dropbox/VU AAA Chemogenomics/5 personal folders/Asli/Ongoing/20191114_TCGA/co_mutation/Output_fishers/p-value/") #drive for the input data
...
path.input = "/Users/akosman/Desktop/geneatlas/"
...
# ## 4. sample annot
# pathS = "~/Desktop/geneatlas/rf_model/input_model/"
# braf_sample = read.table(paste(pathS,  "braf_sample.txt",sep=""), head = TRUE, sep = "\t") 
# egfr_sample = read.table(paste(pathS,  "egfr_sample.txt",sep=""), head = TRUE, sep = "\t") 
# egfrb_sample = read.table(paste(pathS,  "egfrb_sample.txt",sep=""), head = TRUE, sep = "\t") 
# egfrl_sample = read.table(paste(pathS,  "egfr1_sample.txt",sep=""), head = TRUE, sep = "\t") 
# kras_sample = read.table(paste(pathS,  "kras_sample.txt",sep=""), head = TRUE, sep = "\t") 
# pik3ca_sample = read.table(paste(pathS,  "pik3ca_sample.txt",sep=""), head = TRUE, sep = "\t") 
# annot_sample = read.table(paste(pathS,  "annot_samples.txt",sep=""), head = TRUE, sep = "\t") 
